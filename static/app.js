document.addEventListener('DOMContentLoaded', () => {
    ...
    const VALID_EMOTIONS = ['default', 'happy', 'blushed', 'laugh', 'love', 'sad', 'angry']; // 'curious' is currently not used but can be added back easily
    ...
    function startLipSync() {
        ...
        lipSyncInterval = setInterval(() => {
            characterImage.src = getEmotionSrc(currentEmotion, mouthOpen ? 'opened' : 'closed');
            mouthOpen = !mouthOpen;
        }, 150);
    }
